...
describe(`basic serialize`, () => {
    ...
    describe(`EachExpression`, () => {
        it(`each {1,2,3}`, async () => {
            const expected: string = `each {1, 2, 3}`;
        ...
        it(`each if true then 1 else 2`, async () => {
            const expected: string = `each if true then 1 else 2`;
        ...
        it(`each each if true then 1 else 2`, async () => {
            const expected: string = `each each if true then 1 else 2`;
    ...
    describe(`ErrorHandlingExpression`, () => {
        ...
        it(`try {1, 2} otherwise 1`, async () => {
            const expected: string = `try {1, 2} otherwise 1`;
        ...
        it(`try 1 otherwise {1, 2}`, async () => {
            const expected: string = `try 1 otherwise {1, 2}`;
    ...
    describe(`ErrorRaisingExpression`, () => {
        ...
        it(`error {1,2}`, async () => {
            const expected: string = `error {1, 2}`;
        ...
        it(`error if fn(1,2,3) then 1 else 2`, async () => {
            const expected: string = `error if fn(1, 2, 3) then 1 else 2`;
        ...
        it(`error {if true then 1 else 2}`, async () => {
            const expected: string = `error {if true then 1 else 2}`;
    ...
    describe(`IfExpression`, () => {
        it(`if true then true else false`, async () => {
            const expected: string = `if true then true else false`;
        ...
        it(`if true then {1,2,3} else [key=value, cat=dog]`, async () => {
            const expected: string = `if true then {1, 2, 3} else [key = value, cat = dog]`;
        ...
        it(`if true then if true then true else false else false`, async () => {
            const expected: string = `if true then if true then true else false else false`;
        ...
        it(`if x then x else if x then x else x`, async () => {
            const expected: string = `if x then x else if x then x else x`;
    ...
    describe(`ItemAccessExpression`, () => {
        ...
        it(`Foo{[X = 1, Y = 2]}`, async () => {
            const expected: string = `Foo{[X = 1, Y = 2]}`;
        ...
        it(`Foo{if true then 1 else 2}`, async () => {
            const expected: string = `Foo{if true then 1 else 2}`;
    ...
    describe(`InvokeExpression`, () => {
        ...
        it(`Foo(let x = 1 in x)`, async () => {
            const expected: string = `Foo(let x = 1 in x)`;
        ...
        it(`longLinearLength(123456789, 123456789, 123456789, 123456789)`, async () => {
            const expected: string = `longLinearLength(123456789, 123456789, 123456789, 123456789)`;
    ...
    describe(`LetExpression`, () => {
        it(`let x = 1 in x`, async () => {
            const expected: string = `let x = 1 in x`;
        ...
        it(`let x = 1, y = 2 in let lst1 = {1,2}, lst2 = {} in {1,2,3}`, async () => {
            const expected: string = `let x = 1, y = 2 in let lst1 = {1, 2}, lst2 = {} in {1, 2, 3}`;
    ...
    describe(`ListExpression`, () => {
        ...
        it(`let x = Foo(1, {2}) in x`, async () => {
            const expected: string = `let x = Foo(1, {2}) in x`;
        ...
        it(`{if 1 then 2 else 3..4}`, async () => {
            const expected: string = `{if 1 then 2 else 3..4}`;
    ...
    describe(`ListType`, () => {
        ...
        it(`type { table [ foo, bar ] }`, async () => {
            const expected: string = `type {table [foo, bar]}`;
    ...
    describe(`NullableType`, () => {
        ...
        it(`type nullable table [foo, bar]`, async () => {
            const expected: string = `type nullable table [foo, bar]`;
    ...
    describe(`RecordExpression`, () => {
        ...
        it(`let x = Foo(1, [key = value]) in x`, async () => {
            const expected: string = `let x = Foo(1, [key = value]) in x`;
...
`;
    ...
    describe(`TableType`, () => {
        ...
        it(`type table [ foo, optional bar ]`, async () => {
            const expected: string = `type table [foo, optional bar]`;
        ...
        it(`type table [foo = table [key], bar, optional foobar = number]`, async () => {
            const expected: string = `type table [foo = table [key], bar, optional foobar = number]`;
    ...
    describe(`TBinOpExpression`, () => {
        ...
        it(`aReallyReallyReallyReallyLongIdentifier * aReallyReallyReallyReallyLongIdentifier`, async () => {
            const expected: string = `aReallyReallyReallyReallyLongIdentifier * aReallyReallyReallyReallyLongIdentifier`;
        ...
        it(`1 + foo(if true then 1 else 0) + bar (if true then 1 else 0)`, async () => {
            const expected: string = `1 + foo(if true then 1 else 0) + bar(if true then 1 else 0)`;
        ...
        it(`let x = true and true`, async () => {
            const expected: string = `let x = true and true in x`;
        ...
        it(`let x = 1 <> 2 and 3 <> 4 in x`, async () => {
            const expected: string = `let x = 1 <> 2 and 3 <> 4 in x`;
        ...
        it(`true and true and (if true then true else false)`, async () => {
            const expected: string = `true and true and (if true then true else false)`;
        ...
        it(`true and (if true then true else false) and true`, async () => {
            const expected: string = `true and (if true then true else false) and true`;
        ...
        it(`(if true then true else false) and true`, async () => {
            const expected: string = `(if true then true else false) and true`;
    ...
    describe(`TBinOpKeyword`, () => {
        ...
        it(`1 meta (if 1 then 2 else 3)`, async () => {
            const expected: string = `1 meta (if 1 then 2 else 3)`;
        ...
        it(`{1, 2} as list`, async () => {
            const expected: string = `{1, 2} as list`;
        ...
        it(`{1, 2} meta (if 1 then 2 else 3)`, async () => {
            const expected: string = `{1, 2} meta (if 1 then 2 else 3)`;
    ...
    describe(`Type`, () => {
        ...
        it(`type table [ Foo = X(), Bar = Y() ]`, async () => {
            const expected: string = `type table [Foo = X(), Bar = Y()]`;
    ...
    describe(`mixed nesting`, () => {
        ...
        it(`[first=[insideKey=insideValue,lst={1,2,3},emptyLst={}]]`, async () => {
            const expected: string = `[first = [insideKey = insideValue, lst = {1, 2, 3}, emptyLst = {}]]`;
